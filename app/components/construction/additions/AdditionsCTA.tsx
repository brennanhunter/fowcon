...
export default function AdditionsCTA() {
      ...
      <div className="max-w-4xl mx-auto px-4 text-center">
        ...
        >
          ...
          <p className="text-blue-200 text-lg mb-8 max-w-2xl mx-auto">
            Get a free consultation and discover how a custom addition can give your family the
            space it needs — without the hassle of moving.
          </p>
